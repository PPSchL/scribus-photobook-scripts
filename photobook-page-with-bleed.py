...
# bleed by default set to 5 (in mm), TODO still have to implement unit-correcting code
page_available = sp.page_with_bleed(page, 5)
# by default set do 2 by 2 pictures and gutter equal to 0
x_n_picts, y_n_picts, gutter = sp.get_n_images_gutter(my_msg, xnp=2, ynp=2, g=0.0)
