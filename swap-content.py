...
if scribus.selectionCount() < 2:
    scribus.messageBox(
        ...
        "Not enough frames to swap content, need at least 2",
    ...
    # as tuples are immutable, create new namedtuple changing the name (ie with the content eg text vs image etc), but keeping the parameters (x,y,size) of the frame
